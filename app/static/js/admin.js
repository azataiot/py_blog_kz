...
//    });
//}
//Ajax техникасын қолдануға болатынын ескеріңіз, бірақ, бумадағы жою пікірлері жай ғана қолдануға болады, себебі бүкіл бетті қарастыру қажет.
...
function get_articleType_info(url, id) {
    $.getJSON(url, function(data) {
        ...
        $('#ModalTitle').text('Блог блогы жіктеуін өңдеу:' + data.name);
...
function get_articleTypeNav_info(url) {
    $.getJSON(url, function(data) {
        ...
        $('#NavModalTitle').text('Санат шарлауын өзгерту:' + data.name);
