...
article_types = {u'Даму тілі': ['Python', 'Java', 'JavaScript'],
                 'Linux': [u'Linux成长之路', u'Linux运维实战', 'CentOS', 'Ubuntu'],
                 u'Желілік технологиялар': [u'Cisco желілік технологиясы', u'Басқа'],
                 u'Database': ['MySQL', 'Redis'],
                 u'Өмірді сүйіп, өзіңді жақсы көр': [u'Осындай өмір сүру', u'Мектеп заттар',u'Осы заттардың сезімі'],
                 u'Веб-әзірлеу': ['Flask', 'Django'],}
...
class Menu(db.Model):
    ...
    @staticmethod
    def insert_menus():
        menus = [u'Веб-әзірлеу', u'DATABASE', u'Желілік технологиялар', u'Өмірді сүйіп, өзіңді жақсы көр',
                 u'Linux әлемі', u'Даму тілі']
        for name in menus:
            menu = Menu(name=name)
            db.session.add(menu)
            db.session.commit()
    ...
    def return_menus():
        ...
        menus.append((-1, u'Шарлауды таңдамаңыз (бұл санат бөлек шарлау болады)'))
        return menus
...
class ArticleType(db.Model):
    ...
    def insert_system_articleType():
        articleType = ArticleType(name=u'Uncategorized',
                                  introduction=u'Жүйенің әдепкі бойынша жіктелуі жойылмайды.',
    ...
    def insert_articleTypes():
        articleTypes = ['Python', 'Java', 'JavaScript', 'Django',
                        ...
                        u'Linux өсу жолы', u'Linux', u'Басқа',
                        u'Cisco желілік технологиясы', u'Осындай өмір сүру', u'Мектеп заттар',
                        u'Осы заттардың сезімі', 'Flask']
...
class BlogInfo(db.Model):
    ...
    def insert_blog_info():
        blog_mini_info = BlogInfo(title=u'Python блог жүйесі',
                                  signature=u'Өмір үнемі бұзылады!',
                                  navbar='inverse')
...
class Plugin(db.Model):
    ...
    def insert_system_plugin():
        plugin = Plugin(title=u'Блог статистикасы',
                        note=u'Жүйелік қосылатын модуль',
